...
GoodWeek2::GoodWeek2() : AbstractGame(), _cube(nullptr), _camera(nullptr) {}

GoodWeek2::~GoodWeek2() {}

void GoodWeek2::initialize() {
    AbstractGame::initialize();
    std::cout << "Initializing Good Week 2 Demo..." << std::endl;
}

void GoodWeek2::_initializeScene() {
    // Load meshes
